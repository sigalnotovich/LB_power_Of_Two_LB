...
class LbTopo(Topo):
    ...
    def build(self, **_opts):
        ...
        h5 = self.addHost('h5', cls=Client, ip='10.0.0.105/8',
                          defaultRoute='via 10.0.0.1')
        serv0 = self.addHost('serv0', cls=Server, ip='192.168.0.100/24',
        ...
        serv3 = self.addHost('serv3', cls=Server, ip='192.168.0.103/24',
                             defaultRoute='via 192.168.0.1')
        serv4 = self.addHost('serv4', cls=Server, ip='192.168.0.104/24',
                             defaultRoute='via 192.168.0.1')
        serv5 = self.addHost('serv5', cls=Server, ip='192.168.0.105/24',
                             defaultRoute='via 192.168.0.1')
        serv6 = self.addHost('serv6', cls=Server, ip='192.168.0.106/24',
                             defaultRoute='via 192.168.0.1')
        serv7 = self.addHost('serv7', cls=Server, ip='192.168.0.107/24',
                             defaultRoute='via 192.168.0.1')
        serv8 = self.addHost('serv8', cls=Server, ip='192.168.0.108/24',
                             defaultRoute='via 192.168.0.1')
        serv9 = self.addHost('serv9', cls=Server, ip='192.168.0.109/24',
                             defaultRoute='via 192.168.0.1')
        for h, s in [(h1, s1), (h2, s1), (h3, s1), (h4, s1), (h5, s1), (s2, serv0), (s2, serv1), (s2, serv2), (s2, serv3), (s2, serv4), (s2, serv5), (s2, serv6), (s2, serv7), (s2, serv8), (s2, serv9)]:
            self.addLink(h, s)
